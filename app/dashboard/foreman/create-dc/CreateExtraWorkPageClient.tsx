...
export default function CreateExtraWorkPageClient({
  editId,
  initialProjects,
  initialContractors,
  initialSelectedProject,
  initialSelectedContractor,
  initialSelectedPlot,
  initialReason,
  initialNote,
  initialBillingDate,
  initialExistingAttachmentUrls,
  initialAdjustments,
  initialError,
}: {
  editId: string | null
  ...
  initialSelectedContractor: string
  initialSelectedPlot: string
  initialReason: string
  initialNote: string
  initialBillingDate: string
  initialExistingAttachmentUrls: string[]
  ...
  const [selectedContractor, setSelectedContractor] = useState(initialSelectedContractor)
  const [selectedPlot, setSelectedPlot] = useState(initialSelectedPlot)

  const [reason, setReason] = useState(initialReason)
  const [note, setNote] = useState(initialNote)
  const [adjustments, setAdjustments] = useState<Adjustment[]>(initialAdjustments)
  const [newFiles, setNewFiles] = useState<File[]>([])
  const [billingDate] = useState(initialBillingDate)
  ...
  const [existingAttachmentUrls] = useState<string[]>(initialExistingAttachmentUrls)
