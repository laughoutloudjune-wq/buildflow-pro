...
type ContractorTypeRow = Awaited<ReturnType<typeof getContractorTypes>>[number]
type HouseModelListItem = Awaited<ReturnType<typeof getHouseModels>>[number]

export default function BOQDetailPageClient({
  id,
  model,
  initialItems,
  types,
  ...
  const [sourceItems, setSourceItems] = useState<BOQItem[]>([])
  ...
  // add/edit/delete). Used after every item mutation instead of router.refresh().
