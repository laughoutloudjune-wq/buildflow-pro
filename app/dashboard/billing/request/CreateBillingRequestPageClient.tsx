...
import { getBillableJobs, createBillingRequest, getBillingById, updateBillingRequest, getJobProgressHistory } from '@/actions/billing-actions'
...
export default function CreateBillingRequestPageClient({
  editId,
  initialProjects,
  initialContractors,
  initialEditingBilling,
  ...
  initialEditingBilling: BillingDetail
